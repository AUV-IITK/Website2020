const data = {
    ...
    "electrical": [
        ...
        },
        {
            "id":2,
            "title": "Actuation",
            "content": "The vehicle's motion is achieved using BTD150 (from Teledyne SeaBotix) and T200 (from Blue Robotics) thrusters. The BTD150s have brushed DC motors which are operated using MC34932 Dual H-bridge ICs. The T200 is a brushless DC motor, which is controlled using Blue Robotics Basic ESC Rev 3. A Solenoid Actuation board actuates the solenoid  valves used in the vehicle using DRV102 IC (Texas Instruments). The DRV102 helps to save energy and supplies full output for a short interval when triggered. The valves control the servo motors of the marker dropper.",
            "img": ""
        },
        {
            "id":3,
        ...
        },
        {
            "id":4,
            "title": "Sensors",
            "content": "The vehicle uses a 30 bar pressure sensor(from Blue Robotics) which measures the depth with a resolution of 2mm and communicates via I2C protocol with the actuation board. Vehicle needs a visual sensor which can detect and recognize object around its surroundings and take appropriate actions. ANAHITA uses two Logitech C930E cameras. These cameras come with 90◦ field of view, support and 4x zoom in 1080p with autofocus feature and capable of working in low light conditions too.ANAHITA uses the AHRS-8 from Sparton as its primary Inertial Measurement Unit. It is fully temperature compensated over the operating range of -40◦ C to 70◦ C. It has a low power consumption Moreover, power management (Sleep Mode) supports multiple communication protocols and has centripetal acceleration correction.",
            "img": ""
        },
        {
            "id":5,
